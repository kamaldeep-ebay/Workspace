...
public class TwitterApiCalls {
	...
	static String consumer_key="a5PYkkQvWPxOMnXBICpyEVnvZ";
	static String consumer_secret="lrUG8JRHe8vNgzWW32VwFXtvIqRbSX5lvboQMpM1VGs4IlJfR2";
	static String access_token="2850468776-SWUrw5s2DUxpyXbswQ3S4jQ9rWxcucbYbXvePZb";
	static String access_token_secret="aLKffvo2BoSlTRQjadt2TZ5KJ4pGnUgUqmsdZGK4pCSZ6";
	...
	public static void main(String[] args) throws ClientProtocolException, IOException, TwitterException{
		//getTweetsFromUserName("kdsrck119");
		//getTweetsFromHashTag("aap");
		//getTweetsFromJunta("bjp");
		getTweetsFromHashTag("ebay");
	}
